...
{
    /// <summary>
    /// A copy of the old RayObjectPool to work with the ray marching level. TODO: introduce the fixed, new RayObjectPool into the ray marching level as well.
    /// </summary>
    public class RayObjectPool_old
    {
        ...
        public RayObjectPool_old(RayObject rayPrefab, int initialAmount) : this(rayPrefab, initialAmount, null)
        {
        }
        ...
        public RayObjectPool_old(RayObject rayPrefab, int initialAmount, Transform parent)
        {
