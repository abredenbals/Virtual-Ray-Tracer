...
using _Project.UI.Scripts.Ray_Marching;
using _Project.UI.Scripts.Ray_Marching.RM_Control_Panel;
using RuntimeHandle;
using TMPro;
using UnityEngine;
...
namespace _Project.Ray_Tracer.Scripts.Ray_Marching
{
    ...
    /// </summary>
    public class RMSceneManager : MonoBehaviour
    {
        /// <summary>
        ...
        [SerializeField] private RMControlPanel ControlPanel;
        ...
        private static RMSceneManager instance = null;
        ...
        public static RMSceneManager Get()
        {
            return instance;
        }
        ...
        private void OnEvent(RMControlPanel.SignalType signal)
        {
            switch (signal)
            {
                case RMControlPanel.SignalType.RayTracer:
                    Deselect();
                    break;
                case RMControlPanel.SignalType.Camera:
                    Select(Scene.Camera.transform);
                    break;
                case RMControlPanel.SignalType.Object:
